...
from app.middleware.auth_middleware import get_current_user # Need to check if it's core.security or api.deps
from app.controllers.jobs_controller import get_jobs as ctrl_get_jobs
from app.controllers.jobs_controller import get_recommended_jobs as ctrl_get_recommended_jobs
