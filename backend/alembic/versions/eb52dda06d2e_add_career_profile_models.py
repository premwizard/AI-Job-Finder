...
def upgrade() -> None:
    ...
    with op.batch_alter_table("career_preferences", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_career_preferences_id"), ["id"], unique=False
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("user_profiles", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("preferred_locations", sa.VARCHAR(), nullable=True)
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column("preferred_companies", sa.VARCHAR(), nullable=True)
        )
